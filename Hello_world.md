...
- ``print`` makes an output to "file with unit \*", which is usually the screen. "\*," means that the output is in "format \*", which will be automatically determined by the processor with some restriction of Fortran standard.
